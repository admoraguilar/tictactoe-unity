...
We also want to store, in memory, a history of every move played in the game. We don't need to do anything with this data, just store it. Choose the correct data structure for the job.
...
I also included some basic UI sprites. Using them is *completely* optional.
...
#TODO
* Put ResetButton on BottomBar of TicTacToe screen
* Small win sequence for TicTacToe
* Document code
